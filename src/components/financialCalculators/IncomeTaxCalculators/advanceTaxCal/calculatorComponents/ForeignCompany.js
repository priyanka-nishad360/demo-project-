...
import calc_ForeignCompany from "../calc/calc_ForeignCompany";
export default function ForeignCompanyFirms(props) {
    ...
    const handleCalculate = () => {
        const data = calc_ForeignCompany(netTaxableIncome);
        setResultTax({
            ...data,
            assessedTax: "",
        });
