// individual
export function calculateNetIncomeTaxIndividual2021(income) {
    if (income <= 250000) {
...
// senior citizen
export function calculateNetIncomeTaxSeniorC2021(income) {
    if (income <= 300000) {
        return { taxRate: 0, surcharge: 0, educationCess: 0 };
    } else if (income <= 500000) {
...
export function calculateNetIncomeTaxSuperSeniorC2021(income) {
    if (income <= 500000) {
        return { taxRate: 0, surcharge: 0, educationCess: 0 };
    } else if (income <= 1000000) {
