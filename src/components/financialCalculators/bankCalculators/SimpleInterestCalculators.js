      ...
      <div className="max-w-3xl mx-auto bg-white shadow-sm rounded-lg p-4 print-content">
        ...
        <div className="bg-white shadow-sm rounded-lg p-4 flex flex-col sm:flex-row sm:space-x-4">
          <div className="flex-1">
            ...
            <div className={sharedClasses.container}>
              <label className={sharedClasses.label}>Time period</label>
              <div className="flex">
                <input
                  type="number"
                  value={time}
              ...
              "
                ...
                <input
                  ...
                  className="ml-2"
                />
                <span className="ml-2 text-gray-500">Yr</span>
              </div>
            </div>

            <div className={sharedClasses.container}>
              <label className={sharedClasses.label}>Select Time Period</label>
              <select
                value={timePeriod}
          ...
          <div className={resultCard}>
            ...
            <div className="mt-2">
              ...
              <div className="flex justify-between mb-1">
                ...
                <span className={resultValue}>₹{totalInterest.toFixed(0)}</span>
              </div>
              <div className="flex justify-between mb-1">
