      ...
      {showStat && (
        <li className="lg:col-span-2 bg-gray-200 p-4" ref={pdf_ref}>
          <div className="p-4 bg-neutral-50">
            ...
            <h6 className="text-primary text-center mt-5 mb-3">
              Monthly Calculation
            </h6>
              ...
              <table className="min-w-full border border-gray-300">
                ...
                <thead className="border-b">
                  <tr>
                    <th
                      scope="col"
                      className="text-sm font-medium text-gray-900 px-6 py-4 border-r border-b border-gray-300  bg-primary dark:text-whitedark:text-white w-1/6"
                    >
                      Month
                    </th>
                    <th
