            ...
            <section className="p-4 max-w-6xl mx-auto">
                <div className=" flex gap-2 justify-end mb-2 max-w-6xl mx-auto">
                    <Link href={"/dashboard/accounts/invoice/all-purchase/return-purchase"}>
                        <button type="button" className="capitalize flex items-center focus:outline-none text-white bg-orange-400 hover:bg-orange-500 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2  ">
                            return Purchase
                        </button>
                    </Link>
                ...
                <form className="grid md:grid-cols-[1fr_auto] gap-2 items-center max-w-6xl mx-auto">   
                    ...
                    <div className="relative">
                        <input type="search" id="default-search" className="block w-full py-2 px-4 pe-6 text-sm text-neutral-900 border border-neutral-300 rounded-lg bg-neutral-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Name, Address..." required/>
                ...
                <div className="my-4 max-w-6xl max-h-96 mx-auto relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table className="w-full text-sm text-left rtl:text-right text-neutral-500 dark:text-neutral-400">
                        <thead className=" sticky -top-0 shadow-md text-neutral-700 uppercase bg-neutral-50 dark:bg-neutral-700 dark:text-neutral-400">
                            <tr className="border-b-2 dark:border-neutral-900">
                                {itemsData.purchaseData_title.map((item,index)=>
                        ...
                        <tbody className="divide-y divide-gray-100 border-t border-gray-100">
                            {itemsData.purchaseData_body.map((item,i) => (
                    ...
                    {itemsData.purchaseData_body.length === 0 ? ( 
                    <div>
