  ...
  return (
    <div className=" mx-auto bg-white  space-y-4 max-w-4xl">
      <div
        ...
        role="alert"
      >
        <span class="font-medium">9A - Amended B2C Invoices </span>
      </div>
      <div className="p-4">
        <div
        ...
        <div className="text-right my-4">
          <Link href="/dashboard/easy-gst-return/gstr/gstr1/amendrecorddetails/nine-a-b2c/amend-b2c-9a">
