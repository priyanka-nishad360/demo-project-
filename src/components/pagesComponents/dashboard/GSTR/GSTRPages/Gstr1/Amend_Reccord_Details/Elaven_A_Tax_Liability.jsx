  ...
  return (
    <div className=" mx-auto bg-white  space-y-4 max-w-4xl">
      <div
        ...
        role="alert"
      >
        <span class="font-medium">11-A Tax Liability </span>
      </div>
      <div className="p-4">
        <div
        ...
        <div className="text-right my-4">
          <Link href="/dashboard/easy-gst-return/gstr/gstr1/amendrecorddetails/elaven-a-tax-liability/amend-tax-liablity-11a">
...
export default Elaven_A_Tax_Liability;
