    ...
    <>
      <div className=" mx-auto bg-white  space-y-4 max-w-4xl">
        <div
          ...
          role="alert"
        >
          <span class="font-medium"> B2B - Amend Invoices </span>
        </div>
        ...
        <div className="bg-gray-100 p-2 text-sm">
          <input type="checkbox" />
          <label>
            &nbsp; Is the supply eligible to be taxed at a differential
            percentage (%) of the existing rate of tax, as notified by the
            Goverment?
          </label>
        </div>
...
export default Nine_A_b2b_Form;
