    ...
    <div className=" mx-auto bg-white  space-y-4 max-w-4xl">
      ...
      >
        <span class="font-medium">
          11-A Admended of adjustment of (advance recived){" "}
        </span>
      </div>
      <div className="p-4">
        <div
        ...
        <div className="text-right my-4">
          <Link href="/dashboard/easy-gst-return/gstr/gstr1/amendrecorddetails/elaven-a-adjustment/amend-adjustment-11a">
...
export default Elaven_A_Adjustment;
