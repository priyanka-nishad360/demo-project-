...
const Nine_A_Credit_Debit_Notes_Un = () => {
  return (
    <div className=" mx-auto bg-white  space-y-4 max-w-4xl">
      ...
      >
        <span class="font-medium">
          9A - Amended Creadit/Debit Notes Unregistered Invoices{" "}
        </span>
      </div>
      <div className="p-4">
        <div
        ...
        <div className="text-right my-4">
          <Link href="/dashboard/easy-gst-return/gstr/gstr1/amendrecorddetails/nine-a-cr-dr-notes-unreg/amend-cr-dr-notes-unreg-9a">
...
export default Nine_A_Credit_Debit_Notes_Un;
