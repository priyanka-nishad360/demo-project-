    ...
    <>
      <div className=" mx-auto bg-white  space-y-4 max-w-4xl">
        <div
          ...
          role="alert"
        >
          <span class="font-medium">9A - Amended B2B Invoices </span>
        </div>
        <div className="p-4">
          <div
          ...
          >
            <span class="font-medium">
              There are no record to be displayed{" "}
            </span>
          </div>
          ...
          <div className="text-right my-4">
            <Link href="/dashboard/easy-gst-return/gstr/gstr1/amendrecorddetails/nine-a-b2b/amend-b2b-9a">
