...
export default function Edit_Careers() {
                ...
                <form action="">
                    <ul>
                        <li className="sm:col-span-1 col-span-2">
                            <label className="text-txt font-semibold" htmlFor="BlogTitle">Edit_Career</label>
                            <input {...register("BlogTitle",{
                                required:{
                                    value:true,
                                    message:"BlogTitle name is required",
                                }
                            })} 
                            type="text" placeholder="BlogTitle" name="BlogTitle" id="BlogTitle" className="mt-1 bg-bg_2/10 border border-txt/400 focus:border-primary text-txt text-sm block w-full p-2" 
                            />
                            {errors?
                            <small className="text-red-500 italic">{errors.BlogTitle?.message}</small>
                            :""}
                        </li>
                        <li className="sm:col-span-1 col-span-2">
                            <label className="text-txt font-semibold" htmlFor="BlogOverview">BlogOverview</label>
                            <input {...register("BlogOverview",{
                                required:{
                                    value:true,
                                    message:"BlogOverview name is required",
                                }
                            })} 
                            type="text" placeholder="BlogOverview" name="BlogOverview" id="BlogOverview" className="mt-1 bg-bg_2/10 border border-txt/400 focus:border-primary text-txt text-sm block w-full p-2" 
                            />
                            {errors?
                            <small className="text-red-500 italic">{errors.BlogOverview?.message}</small>
                            :""}
                        </li>
                    </ul>
                </form>
