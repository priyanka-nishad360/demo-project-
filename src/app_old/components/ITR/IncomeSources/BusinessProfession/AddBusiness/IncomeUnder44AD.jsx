...
export default function IncomeUnder44AD({setSection}) {
    return (
        <div className="mx-auto max-w-4xl w-full">
            ...
            <div className="grid grid-cols-3 gap-5">
                <p></p>
                <p className="text-center">Non-Digital Transactions (8%)</p>
                <p className="text-center">Non-Digital Transactions (8%)</p>
                <label
                    htmlFor="firstName"
                    className="text-sm font-medium flex items-center"
                >
                    Nature of BusinessGross turnover or Gross Receipts
                </label>
                <input
                    type="text"
                    name="firstName"
