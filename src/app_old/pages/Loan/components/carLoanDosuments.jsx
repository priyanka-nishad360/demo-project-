  ...
  return (
    <div className="min-h-screen">
      <form
        ...
        className="md:w-3/4 mt-20 min-h-screen mx-auto  shadow-xl  p-5 rounded bg-white"
      >
        ...
        <FileInput
          ...
          control={control}
          label="Form-16"
          rules={{ required: "Form-16 is required" }}
          errors={errors}
        />
        <FileInput
          name="salerySlip"
...
export default CarLoanDosuments;
