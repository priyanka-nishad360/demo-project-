    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <FileInput
          ...
          control={control}
          label="GSTR 1 year"
          rules={{ required: "GSTR is required" }}
          errors={errors}
        />
        <FileInput
          name="26AS"
          ...
          control={control}
          label="26AS"
          rules={{ required: "26AS is required" }}
          errors={errors}
        />
...
export default BuisnessLoanDocuments;
