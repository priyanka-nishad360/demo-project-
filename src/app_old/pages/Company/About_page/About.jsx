  ...
  return (
    <>
      <div className="bt-green-50 text-justify  rounded-4xl text-2xl container mx-auto ">
        <div
          className="header text-center text-5xl font-semibold  pt-28 "
          
        >
          About Us
        </div>
        <div
          className="header2 text-center  text-xl  pt-3 "
        >
          Know Who We Are
        </div>
      </div>
      <div className="container mx-auto mt-10 ">
        <div className="grid md:grid-cols-2 sm:grid-cols-1 ">
          <div>
            <Image  src="/images/aboutt.jpg" width={700} height={700} alt="about_image" />
          </div>
          <div>
            <div className="px-8  space-y-6 pt-36">
              ...
              {/* <div className="flex space-x-2 justify-left">
                <button
                  type="button"
                  className="inline-block px-6 py-2.5 bg-blue-900 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
                >
                  Learn More
                </button>
              </div> */}
        ...
        <div>
          ...
          <div className=" relative container mx-auto shadow-lg rounded-xl grid my-20 md:grid-cols-2 sm:grid-cols-1 gap-4 ">
            ...
            <div className="vision_image">
              <Image width={500} height={500} src="/images/grow.png" alt="our vision" />
            </div>
      ...
      {/* <div className="hidden">
        <div className="header text-center text-5xl font-serif pt-28 ">
          Team Members
        </div>
        <div className="header2 text-center text-xl font-serif pt-3 ">
          Meet Our Experts
        </div>
                ...
                return (
                  <div className="w-80 mx-8 overflow-hidden" key={dev?.i}>
                    ...
                    <div className="shadow-xl">
                      ...
                      <div className=" bg-blue-50 text-center font-serif text-xl  ">
                        {dev?.designation}
                      </div>
                    </div>
                  </div>
...
const devs = [
  {
    i: 0,
    name: "Harsh Singh",
    photo: "images/harshs.jpeg",
    designation: "ReactJs Developer",
  },
  {
    i: 1,
    name: "Bal Govind Maurya",
    photo: "images/govind.jpg",
