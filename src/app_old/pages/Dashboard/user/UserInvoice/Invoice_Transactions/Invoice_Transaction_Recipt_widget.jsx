...
const TransRData = [
  {
    ...
    iconName: "material-symbols:analytics-rounded",
  },
  {
    upcoming: false,
    title: "Total Receipts This Week",
    overview: "350",
...
const Invoice_Transaction_Recipt_widget = () => {
  return (
    <>
...
export default Invoice_Transaction_Recipt_widget;
