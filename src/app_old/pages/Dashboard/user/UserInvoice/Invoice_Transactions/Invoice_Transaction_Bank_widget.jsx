...
const TransRData = [
  {
    upcoming: false,
    title: "Total Bank Deposits Today",
    overview: "3520",
    time: "10% + since yesterday ",
    // linkTo: "/dashboard/easy-investment/life-insurance/bajaj",
    iconName: "pepicons-pop:bank",
  },
  {
    upcoming: false,
    title: "Total Bank Withdrawals Today",
    overview: "350",
  ...
  {
    upcoming: false,
    title: "View All Bank Transactions",
    overview: "₹ 103,430",
...
const Invoice_Transaction_Bank_widget = () => {
  return (
    <>
...
export default Invoice_Transaction_Bank_widget;
