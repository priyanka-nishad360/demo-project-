...
const SimpleInterestCal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data={
      principle:principalRef.current.value,
      interestEarned:(Number(principalRef.current.value)*Number(roiRef.current.value)*Number(timeperiodRef.current.value))/100,
    }
    setShowData(data)
    setLoading(false);
    setShowStat(true);
        ...
        <li>
          <form action="" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-4 lg:p-4 place-content-center grid-cols-[repeat(auto-fill,_minmax(120px,_1fr))] xl:grid-cols-2 lg:grid-cols-[repeat(auto-fill,_minmax(120px,_1fr))]">
                ...
                {showStat && (
                <button type="button" className="btn-primary " onClick={generatePDF}>Print</button>
                )}
                {showStat && (
          ...
          {showStat ? (
            <div className="bg-gray-50 p-4 grid lg:grid-cols-2 gap-4 place-content-center">
                <div className="m-auto p-4 lg:col-span-2">
                    <Pie data={data} />
                </div>
              <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm  mx-4">
                <h5 className="text-gray-900 text-xl leading-tight font-medium mb-5 text-left">
                  Principal
                </h5>
                             ...
                             <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
                                 <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                                     <div className="overflow-hidden">
                                         <h6 className='text-primary mt-5'>Yearly Calculation</h6>
