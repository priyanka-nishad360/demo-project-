...
const BusinessCal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(`${MOM_ITAX_URL}/calculator/miscellaneous/business-loan-emi`, {
      ...
      .then(function (response) {
        ...
        const showdata = response.data.results;
        let total = +showdata.totalAmount;
        const emi = +showdata.emi;
  ...
  return (
    <SearchResult_section title="Business Loan Calculator">
        <li>
                    ...
                    <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                        ...
                        <table className="min-w-full border border-gray-300">
                            ...
                            <tr>
                                <th
                                scope="col"
                                className="text-gray-900 px-6 py-4 border-r border-b border-gray-300  bg-primary dark:text-white text-sm w-1/6"
                                >
                                Month
                                </th>
                                <th
