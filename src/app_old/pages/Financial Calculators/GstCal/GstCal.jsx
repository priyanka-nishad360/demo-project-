  ...
  return (
    <SearchResult_section title="GST Calculator">
        ...
        <li className="lg:col-span-2 space-y-4 bg-gray-200 p-4" ref={pdf_ref}>
            {showStat ? (
            <>
               <div className="m-auto p-4 bg-neutral-50">
                    <Pie data={data} />
                </div>
                <div className="grid grid-cols-[repeat(auto-fill,_minmax(200px,_1fr))] gap-4 place-content-center">
                    ...
                    <h3 className="text-2xl">
                        ₹ <span className="text-xl">{showdata.amount || 0}/-</span>
                    </h3>
                    {/* {signMap[type]} */}
                    </div>
                    <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm mx-4">
                    ...
                    <h3 className="text-2xl">
                        ₹ <span className="text-xl">{showdata.gstAmount || 0}/-</span>
                    </h3>
                    </div>
                    <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm mx-4">
                    <h5 className="text-gray-900 text-xl leading-tight font-medium mb-5 ">
                    ...
                    <h3 className="text-2xl">
                        ₹ <span className="text-xl">{showdata.finalAmount || 0}/-</span>
                    </h3>
                    </div>
                    {/* <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm mx-4">
                    ...
                    <h3 className="text-2xl">
                        <span className="text-xl">{showdata.gstRate || 0}%</span>
                    </h3>
                    </div> */}
                </div>
            </>
