...
const FdCal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(`${MOM_ITAX_URL}/calculator/miscellaneous/fixed-deposit`, {
            ...
            <>
                ...
                <div>
                    ...
                    <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm  mx-4">
                        ...
                        ₹ <span className="text-xl">{showdata.principle}/-</span>
                        </h3>
                    </div>
                    <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm  mx-4">
                        <h5 className="text-gray-900 text-xl leading-tight font-medium mb-5 text-center">
                        ...
                        <h3 className="text-2xl">
                        ₹{" "}
                        <span className="text-xl">{showdata.interestEarned}/-</span>
                        </h3>
                    </div>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="py-10 inline-block min-w-full sm:px-6 lg:px-8">
                            ...
                            <h6 className="text-primary mt-5 text-center">
                                Yearly Calculation
                            </h6>
