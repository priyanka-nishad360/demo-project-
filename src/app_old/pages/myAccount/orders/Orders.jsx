            ...
            <div className='relative overflow-x-auto  outline outline-2 outline-gray-300/50 rounded-lg'>
                <table className='w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400'>
                    <thead className="text-xs uppercase ">
                        <tr>
                            {data.table.orders_thead.map((item, index) => (
                    ...
                    <tbody>
                            {data.table.orders.map((item, index) => (
                                <tr key={index+item.order_id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 capitalize">
